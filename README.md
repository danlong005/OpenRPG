...
**96.1%** — of the 309 test programs in this repository, rpgc does the same thing as IBM's ILE RPG compiler with 297: both compile the program, or both reject it.
