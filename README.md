...
**84.9%** — of the 291 test programs in this repository, rpgc does the same thing as IBM's ILE RPG compiler with 247: both compile the program, or both reject it.
