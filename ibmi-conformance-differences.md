...
**Agreement: 171 of 265 (65%).** A shared rejection counts as agreement: it is a negative test working as designed.

## IBM rejects, rpgc accepts — 88 files
...
| RNF7016: Display length n greater than maximum allowed of n; specification is ignored. | 11 |
...
- `test218_prog_payroll.rpgle` — line 94: Display length 70 greater than maximum allowed of 52; specification is ignored. — `C     RPTLIN        DSPLY`
...
| RNF7016 | 17 | Display length 100 greater than maximum allowed of 52; specification is ignored. |
...
#### `test218_prog_payroll.rpgle`

- **RNF7016** (sev 20, line 94): Display length 70 greater than maximum allowed of 52; specification is ignored.
  - `C     RPTLIN        DSPLY`
- **RNF7016** (sev 20, line 129): Display length 70 greater than maximum allowed of 52; specification is ignored.
  - `C     RPTLIN        DSPLY`
- **RNF7016** (sev 20, line 136): Display length 70 greater than maximum allowed of 52; specification is ignored.
  - `C     RPTLIN        DSPLY`
- **RNF7016** (sev 20, line 139): Display length 70 greater than maximum allowed of 52; specification is ignored.
  - `C     RPTLIN        DSPLY`
- **RNF7016** (sev 20, line 141): Display length 70 greater than maximum allowed of 52; specification is ignored.
  - `C     RPTLIN        DSPLY`
- **RNF7016** (sev 20, line 145): Display length 70 greater than maximum allowed of 52; specification is ignored.
  - `C     RPTLIN        DSPLY`
