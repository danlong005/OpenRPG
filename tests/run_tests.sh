...
run_test "226" "INZ on a DS subfield" "$TESTDIR/test226_subfield_inz.rpgle" "run"
...
run_test "239" "Overflow 103 / divide-by-zero 102" "$TESTDIR/test239_numeric_overflow.rpgle" "run"
